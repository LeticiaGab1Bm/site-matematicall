...
<head>
	...
	<title>OMC - Olindamir Merlin Claudino</title>
		...
		<section class="professores">
			...
			<div class="professores-todos">
				...
				<div class="professor-div">
					<img class="professor-imagem" src="foto-rosane2.jpg" alt="foto da professora Rosane">
					<h3 class="professor-nome">Rosane</h3>
					<p class="professor-texto">1° Diretora</p>
					<p class="professor-texto">25 anos de profissão - Educação Física</p>
				</div>

				<div class="professor-div">
					<img class="professor-imagem" src="foto-rone.jpg" alt="foto da professora Rone">
					<h3 class="professor-nome">Marise</h3>
					<p class="professor-texto"> anos anos de profissão - </p>
				...
				<div class="professor-div">
					...
					<p class="professor-texto"> anos de profissão - </p>
					<p class="professor-texto">Diretora - Português</p>
				</div>
				...
				<div class="professor-div">
					...
					<p class="professor-texto">Professor</p>
					<p class="professor-texto">23 anos de profissão - Geografia</p>
				</div>
